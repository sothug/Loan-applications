# Информационная система приёма заявок на кредит
## `Содержание`
[Введение](#introduction)  
1 [Описание предметной области](#description)  
2 [Аналази существующих решений](#existing)  
3 [Разработка информационной системы](#development)  
...
<div class="newLine" style="page-break-after: always"></div>
...
## 1 Описание предметной области <a name="description"></a>
...
## 2 Аналази существующих решений <a name="existing"></a>
...
## 3 Разработка информационной системы <a name="development"></a>
...
<a name="figure_1">
    <p align="center">
        <img style="" src="https://raw.githubusercontent.com/sothug/Loan-applications/main/Diagrams/SVG/Use%20Case.drawio.svg"><br>
